...
mapa = {
    ...
    "__TEX_AGUA__":     embutir(bem("texturas", "tex-agua.png"),
                                (512, 512), qualidade=86),
    "__PAPEL_COR__":     embutir(bem("texturas", "papel-teatro-cor.jpg"), (2560, 1072), qualidade=86),
    "__PAPEL_MASCARA__": embutir(bem("texturas", "papel-teatro-mascara.png"), (2560, 1072), com_alfa=True),
