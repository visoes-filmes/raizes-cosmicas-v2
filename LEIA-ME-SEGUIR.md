...
| **7.8** | **a que está no ar** (25/09, noite): **de volta aos dez minutos** — "agora tem mais elementos para ver no primeiro cenário". `DURACAO_REAL = 600`; o portão e a Cabine dizem dez | `index` e `v6.html` | `v7.8` |
...
- cada rodada grande ganha **número de versão novo** e uma marca (`git tag`) — a próxima é a **7.9**;
