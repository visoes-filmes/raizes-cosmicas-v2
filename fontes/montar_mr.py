...
if saida == os.path.join(RAIZ, "index.html"):
    ...
    v6 = (v52.replace("const TELA_DE_TULE          = false;", "const TELA_DE_TULE          = true;")
             ...
             .replace("<title>Raízes Cósmicas 5.2</title>", "<title>Raízes Cósmicas 6.7</title>")
             .replace("<h1>Raízes Cósmicas 5.2</h1>", "<h1>Raízes Cósmicas 6.7</h1>")
             .replace('Raízes Cósmicas <em>5.2</em>', 'Raízes Cósmicas <em>6.7</em>')
