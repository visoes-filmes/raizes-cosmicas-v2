...
| **7.9** | **a que está no ar** (25/09, noite): **a vitrine** — "a capa inicial está muito sem graça; uma imagem do cenário se movendo num loop, sem dar spoiler". Atrás do portão a própria obra fica viva, parada aos 0:40 do roteiro (floresta crescida, rios de luz se desenhando; antes dos seres), câmera olhando para cima e girando devagar; o portão virou vinheta translúcida com a caixa de texto sobre fundo escuro. Liga ao terminar de carregar e sempre que o portão volta | `index` e `v6.html` | `v7.9` |
