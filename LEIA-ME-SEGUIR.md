...
| **7.6** | **a que está no ar** (25/09, noite): **sem montanhas** — "estão num horizonte, e esse horizonte, quando vai para a realidade aumentada, não faz sentido; melhor tirar". `MONTANHAS = false` apaga o horizonte desenhado e o modelo; na linha dos olhos fica só a sala real | `index` e `v6.html` | `v7.6` |
...
- cada rodada grande ganha **número de versão novo** e uma marca (`git tag`) — a próxima é a **7.7**;
